...
//				<demorph|clear|morphtarget> [player] [force (true/false)]
                ...
                if (player != null) {
                    ...
                    if (tag.hasKey(args[1] + "_morphData")) {
                        ...
                        FMLServerHandler.instance().getServer().getConfigurationManager().getPlayerForUsername(args[1]);

                        Morph.proxy.tickHandlerServer.saveSaveData(tag, FMLServerHandler.instance().getServer().getConfigurationManager().getPlayerForUsername(args[1]));
                ...
                if (player != null) {
                    ...
                    if (tag.hasKey(args[1] + "_morphStatesCount")) {
                        tag.removeTag(args[1] + "_morphStatesCount");
                    }
                    Morph.proxy.tickHandlerServer.saveSaveData(tag, FMLServerHandler.instance().getServer().getConfigurationManager().getPlayerForUsername(args[1]));
                    notifyAdmins(icommandsender, "Clearing " + args[1] + "'s morphs");
                }
